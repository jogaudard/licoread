...
The goal of licoread is to provide an easy way to load licor files as R objects that can be used with the [Fluxible](https://plant-functional-trait-course.github.io/fluxible/) package.
