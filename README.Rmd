...
The goal of licoread is to provide an easy way to load licor files as R objects that can be used by the [Fluxible](https://plant-functional-trait-course.github.io/fluxible/) pacakge.
